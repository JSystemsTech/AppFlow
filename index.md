<section class="page-header">
    ...
    <h2>Testing customized layout</h2>
    <h2 class="project-tagline">{{ site.description | default: site.github.project_tagline }}</h2> {% if site.github.is_project_page %}
...
<section class="main-content">
    ...
    <div class="app-tray tray-cayamn" id="myAppTray">
        <div class="app">
            ...
            <div class="app-content">
                <div class="row">
                    ...
                    <div class="app-close pull-right btn btn-danger"><i class="fa fa-close"></i>
                    </div>
                </div>
                ...
                <form class="app-settings">
                    <div class="row">
                        ...
                        <div class="col-xs-6 col-sm-6 col-md-3">
                            ...
                            <div class="radio">
                                <label>
                                    <input type="radio" value="app-height-span-1" name="app-height-span">App Height Span 1</label>
                            </div>
                            <div class="radio ">
                                <label>
                                    <input type="radio" value="app-height-span-3" name="app-height-span">App Height Span 3</label>
        ...
        <div class="app">
            <div class="app-header app-icon"><i class="fa fa-search"></i>
            </div>
            <div class="app-content">
                <div class="row">
        ...
        <div class="app">
            <div class="app-header app-icon"><i class="fa fa-user"></i>
            </div>
            <div class="app-content">
                <div class="row">
