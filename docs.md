...
<div class="section">
<div class="bn btn-appflow">View On Github</div>
<div class="bn btn-appflow">AppFlow Sandbox</div>
<div class="bn btn-appflow"><i class="fa fa-home">Home</i></div>
</div>
<div class="section app-tray app-size-auto ">
  <div class="app">
    <div class="app-header app-icon"><i class="fa fa-cog"></i></div>
    <div class="app-content">
    <div class="col-xs-2 col-sm-1 app-close"><i class="fa fa-chevron-left">Back</i></div>
